...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit Himecoin Node", Q_NULLPTR));
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter an Alias (friendly name) for your Master Node and its address (either clearnet IP and port or Tor onion address and port). The address should be in the format 123.456.789.123:9999 or akjdsafxjkhasdf.onion:9999. You must send exactly 2500 HME to the collateral address.</p></body></html>", Q_NULLPTR));
        ...
        label_3->setText(QApplication::translate("AddEditAdrenalineNode", "Reward Address", Q_NULLPTR));
        label_7->setText(QApplication::translate("AddEditAdrenalineNode", "Reward %", Q_NULLPTR));
