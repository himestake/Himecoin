...
public:
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "Himecoin Node Count:", Q_NULLPTR));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Himecoin Network", Q_NULLPTR));
