...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Himecoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Himecoin</b> version", Q_NULLPTR));
...
"Copyright \302\251 2014 The Himecoin developers", Q_NULLPTR));
