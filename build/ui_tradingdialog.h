...
public:
    ...
    QLabel *label_11;
    QLabel *HAVBalanceLabel;
    QLabel *label_12;
    QLabel *BitcoinBalanceLabel;
    QSpacerItem *horizontalSpacer_4;
    QLabel *label_13;
    QLabel *HAVAvailableLabel_2;
    QLabel *label_15;
    QLabel *BitcoinAvailableLabel;
    QLabel *label_14;
    QLabel *HAVPendingLabel;
    QLabel *label_31;
    ...
    void setupUi(QDialog *tradingDialog)
    {
        ...
        HAVAvailableLabel = new QLabel(BuyTab);
        HAVAvailableLabel->setObjectName(QStringLiteral("HAVAvailableLabel"));
        QPalette palette1;
        ...
        HAVAvailableLabel->setPalette(palette1);
        HAVAvailableLabel->setFont(font3);
        HAVAvailableLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        horizontalLayout->addWidget(HAVAvailableLabel);

        labelHAV = new QLabel(BuyTab);
        labelHAV->setObjectName(QStringLiteral("labelHAV"));
        labelHAV->setFont(font3);

        horizontalLayout->addWidget(labelHAV);
        ...
        UnitsInputHAV = new QLineEdit(BuyTab);
        UnitsInputHAV->setObjectName(QStringLiteral("UnitsInputHAV"));
        UnitsInputHAV->setMinimumSize(QSize(0, 0));
        UnitsInputHAV->setFont(font5);

        gridLayout_6->addWidget(UnitsInputHAV, 4, 9, 1, 1);
        ...
        BuyHAV = new QPushButton(BuyTab);
        BuyHAV->setObjectName(QStringLiteral("BuyHAV"));

        gridLayout_6->addWidget(BuyHAV, 7, 3, 1, 1);

        SellHAVBTN = new QPushButton(BuyTab);
        SellHAVBTN->setObjectName(QStringLiteral("SellHAVBTN"));

        gridLayout_6->addWidget(SellHAVBTN, 7, 9, 1, 1);
        ...
        HAVDemand = new QLabel(BuyTab);
        HAVDemand->setObjectName(QStringLiteral("HAVDemand"));
        QFont font6;
        font6.setPointSize(8);
        HAVDemand->setFont(font6);
        HAVDemand->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(HAVDemand, 0, 1, 1, 5);

        HAVSupply = new QLabel(BuyTab);
        HAVSupply->setObjectName(QStringLiteral("HAVSupply"));
        HAVSupply->setAlignment(Qt::AlignRight|Qt::AlignTrailing|Qt::AlignVCenter);

        gridLayout_6->addWidget(HAVSupply, 0, 9, 1, 3);
        ...
        BittrexHAVLabel = new QLabel(tab);
        BittrexHAVLabel->setObjectName(QStringLiteral("BittrexHAVLabel"));
        QPalette palette7;
        ...
        BittrexHAVLabel->setPalette(palette7);
        BittrexHAVLabel->setFont(font7);
        BittrexHAVLabel->setAutoFillBackground(false);
        BittrexHAVLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        horizontalLayout_8->addWidget(BittrexHAVLabel);
        ...
        HAVBalanceLabel = new QLabel(BalanceTab);
        HAVBalanceLabel->setObjectName(QStringLiteral("HAVBalanceLabel"));
        HAVBalanceLabel->setFont(font4);
        HAVBalanceLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HAVBalanceLabel, 0, 3, 1, 1);
        ...
        HAVAvailableLabel_2 = new QLabel(BalanceTab);
        HAVAvailableLabel_2->setObjectName(QStringLiteral("HAVAvailableLabel_2"));
        HAVAvailableLabel_2->setFont(font4);
        HAVAvailableLabel_2->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HAVAvailableLabel_2, 1, 3, 1, 1);
        ...
        HAVPendingLabel = new QLabel(BalanceTab);
        HAVPendingLabel->setObjectName(QStringLiteral("HAVPendingLabel"));
        HAVPendingLabel->setFont(font4);
        HAVPendingLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);

        gridLayout_2->addWidget(HAVPendingLabel, 2, 3, 1, 1);
        ...
        HAVBalanceLabel->raise();
        HAVAvailableLabel_2->raise();
        HAVPendingLabel->raise();
    ...
    void retranslateUi(QDialog *tradingDialog)
    {
        ...
        label232_2->setText(QApplication::translate("tradingDialog", "HME Available:", Q_NULLPTR));
        HAVAvailableLabel->setText(QApplication::translate("tradingDialog", " 0.00000000 ", Q_NULLPTR));
        labelHAV->setText(QApplication::translate("tradingDialog", " HME", Q_NULLPTR));
        Buy_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", Q_NULLPTR));
        label_4->setText(QApplication::translate("tradingDialog", "HME", Q_NULLPTR));
        Sell_Max_Amount->setText(QApplication::translate("tradingDialog", "Max", Q_NULLPTR));
        label_22->setText(QApplication::translate("tradingDialog", "HME", Q_NULLPTR));
        ...
        BuyHAV->setText(QApplication::translate("tradingDialog", "Buy HME", Q_NULLPTR));
        SellHAVBTN->setText(QApplication::translate("tradingDialog", "Sell HME", Q_NULLPTR));
        ...
        HAVDemand->setText(QApplication::translate("tradingDialog", "Demand: 0.00000000 HME", Q_NULLPTR));
        HAVSupply->setText(QApplication::translate("tradingDialog", "Supply: 0.00000000 HME", Q_NULLPTR));
        ...
        label_32->setText(QApplication::translate("tradingDialog", "Amount in HME:", Q_NULLPTR));
        CSTotalLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", Q_NULLPTR));
        label_35->setText(QApplication::translate("tradingDialog", "HME", Q_NULLPTR));
        ...
        label_29->setText(QApplication::translate("tradingDialog", "HME Balance:", Q_NULLPTR));
        BittrexHAVLabel->setText(QApplication::translate("tradingDialog", " 0.00000000", Q_NULLPTR));
        label_30->setText(QApplication::translate("tradingDialog", "HME", Q_NULLPTR));
        ...
        label_11->setText(QApplication::translate("tradingDialog", "HME Balance:", Q_NULLPTR));
        HAVBalanceLabel->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        label_13->setText(QApplication::translate("tradingDialog", "HME Available:", Q_NULLPTR));
        HAVAvailableLabel_2->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        label_14->setText(QApplication::translate("tradingDialog", "HME Pending:", Q_NULLPTR));
        HAVPendingLabel->setText(QApplication::translate("tradingDialog", "0.00000000", Q_NULLPTR));
        ...
        GenDepositBTN->setText(QApplication::translate("tradingDialog", "Generate HME Coin Deposit Address", Q_NULLPTR));
        ...
        label_34->setText(QApplication::translate("tradingDialog", "Withdraw HME:", Q_NULLPTR));
