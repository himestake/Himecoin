...
const string strMessageMagic = "Himecoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if(nHeight == 2){
        nSubsidy =  36100000  * COIN; //premine
    }
...
const int MONTHLY_BLOCKCOUNT = 43200;

if(nHeight < MONTHLY_BLOCKCOUNT * 9)
    {
        nSubsidy = 0.2 * COIN;
    }
...
{
    int64_t ret = blockValue * 0.99; //99% Masternode Reward from POS
    return ret;
}
