    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Himecoin and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizeHimecoinAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("himecoin-darksend");
