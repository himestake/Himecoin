...
static const int64_t STATIC_POS_REWARD = 1 * COIN; //Constant reward of 1 HME per COIN
...
static const int64_t MAX_MONEY = 190000000 * COIN; // 180M coins
...
inline int64_t GetMNCollateral(int nHeight) { return 5000000; }
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // bth: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
    int64_t nMoneySupply;
#endif
    unsigned int nFlags;  // bth: block index flags
    enum
    {
