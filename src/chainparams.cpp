...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("04230591895a2a274a733989e10bd15f9cf7bfc26fcfcsandid72d584378bd208c59f7809220154bd808b53ccbd422e864f359105f277a30026752fd404a0fc76");
        nDefaultPort = 3131;
        nRPCPort = 3132;
        ...
        const char* pszTimestamp = "Hime is the Japanese word for princess so we moon like a princess";
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1536081636;
        genesis.nBits    = 0x1e0ffff0; 
        genesis.nNonce   = 57182;
        ...
        assert(hashGenesisBlock == uint256("0x00006a155c89a914c23c00377b1abb5b8393912428f158fea17e871e1ba55c3b"));
        assert(genesis.hashMerkleRoot == uint256("0xaf61dbe18f6fd5de44aaf701be33fc72911bcea217dc7f307e3983ca94463dbf"));
        ...
        vSeeds.push_back(CDNSSeedData("0",  "seed0.himestake.com"));
        vSeeds.push_back(CDNSSeedData("1",  "seed1.himestake.com"));
        vSeeds.push_back(CDNSSeedData("2",  "seed2.himestake.com"));
        vSeeds.push_back(CDNSSeedData("3",  "seed3.himestake.com"));
        vSeeds.push_back(CDNSSeedData("4",  "seed4.himestake.com"));
        vSeeds.push_back(CDNSSeedData("5",  "seed5.himestake.com"));
        vSeeds.push_back(CDNSSeedData("6",  "seed6.himestake.com"));
         convertSeeds(vFixedSeeds, pnSeed, ARRAYLEN(pnSeed), nDefaultPort);

        nPoolMaxTransactions = 3;
        //strSporkKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        //strMasternodePaymentsPubKey = "046f78dcf911fbd61910136f7f0f8d90578f68d0b3ac973b5040fb7afb501b5939f39b108b0569dca71488f5bbf498d92e4d1194f6f941307ffd95f75e76869f0e";
        strDarksendPoolDummyAddress = "SaxhsJsH2vrWUGLhJXhknpNSAGC6TJCBc";
